...
export default function SideMenu({ isSearchDisplayed, setIsSearchDisplayed }) {
	...
	return (
		<header className=" relative flex justify-center content-center">
			<div className="p-0 mx-3 flex items-center justify-between w-full py-6">
			...
			<div
				className="left-0 h-full w-64 fixed shadow-2xl bg-white transition-all duration-500 ease-out pt-10"
